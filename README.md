...
<ul>
  ...
  <li><a href="#how-discovery-works-without-api-keys">How discovery works without API keys</a></li>
  <li><a href="#customizing-venues-and-sources">Customizing venues and sources</a></li>
  <li><a href="#privacy-and-data-flow">Privacy and data flow</a></li>
...
`uv sync` installs the `fastembed` *library*
...
The table of contents above is generated. After adding or renaming a `##`/`###`
heading, run:
...
`tests/test_readme_toc.py` fails if you forget, and also if any link points at
